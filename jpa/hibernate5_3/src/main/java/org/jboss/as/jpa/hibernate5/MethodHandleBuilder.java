...
/**
 * stateful MethodHandleBuilder helps construct a series of MethodHandle's.
 *
 * Usage:
 * MethodHandleBuilder mhb = new MethodHandleBuilder();
 * mhb.classLoader(moduleIdentifier).className("ClientClass")
...
public class MethodHandleBuilder {
    ...
    public MethodHandleBuilder classLoader(ClassLoader classLoader) {
