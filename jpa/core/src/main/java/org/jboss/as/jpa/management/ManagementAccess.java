...
public class ManagementAccess {
    ...
    private static final Map<String,ResourceDescriptionResolver> existingResourceDescriptionResolver = new HashMap<>();
    ...
    public static Resource createManagementStatisticsResource(final ManagementAdaptor managementAdaptor, final String scopedPersistenceUnitName) {
        synchronized (existingResourceDescriptionResolver) {
            ...
            ResourceDescriptionResolver resourceDescriptionResolver = existingResourceDescriptionResolver.get(managementAdaptor.getVersion());
            if (resourceDescriptionResolver == null) {

                // setup statistics (this used to be part of JPA subsystem startup)
                resourceDescriptionResolver = new StandardResourceDescriptionResolver(
                ...
                existingResourceDescriptionResolver.put(managementAdaptor.getVersion(), resourceDescriptionResolver);
            }
