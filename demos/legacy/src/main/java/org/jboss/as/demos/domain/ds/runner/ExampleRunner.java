...
public class ExampleRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Throwable parent = e;
            while (parent != null) {
                if (parent instanceof NameNotFoundException && e.getMessage().indexOf("ExampleDS") > -1) {
                    usage(parent);
                    return;
                }
    ...
    private static void usage(Throwable t) throws Exception {
        ...
        System.out.println("Please make sure your domain.xml includes the ExampleDS datasource in its <profile name=\"default\"> element.");
        ...
        System.out.println("        <datasource jndi-name=\"java:jboss/datasources/ExampleDS\" enabled=\"true\" use-java-context=\"true\" pool-name=\"ExampleDS\">");
