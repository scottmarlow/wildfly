...
public class Hibernate2LCacheStatsTestCase {
    ...
    private static final String FACTORY_CLASS = "<property name=\"hibernate.cache.region.factory_class\">org.infinispan.hibernate.cache.v53.InfinispanRegionFactory</property>";
