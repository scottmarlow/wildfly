...
public class Hibernate4NativeSetupwithMetaDataTestCase {
    ...
    public static Archive<?> deploy() throws Exception {
        ...
        lib.addClasses(SFSBHibernatewithMetaDataSession.class);
        ear.addAsModule(lib);
        ...
        main.addClasses(Hibernate4NativeSetupwithMetaDataTestCase.class);
    ...
    public void testMetaData() throws Exception {
        SFSBHibernatewithMetaDataSession sfsb = lookup("SFSBHibernatewithMetaDataSession",
