...
public class CassandraDriverExtension implements Extension {
    ...
    protected static final PathElement HOSTS_PATH = PathElement.pathElement(CommonAttributes.HOSTS);
    ...
    private static final CassandraDriverSubsystemParser parser = new CassandraDriverSubsystemParser();
