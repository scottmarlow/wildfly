...
lightweight and powerful implementation of the Jakarta Enterprise Edition {javaee_version}
...
[cols=",,,,",options="header"]
|=======================================================================
|Jakarta EE {javaee_version} Platform Technology |Jakarta EE {javaee_version} Full Profile |Jakarta EE {javaee_version} Web
...
** Jakarta Enterprise Edition {javaee_version} web profile certified configuration with
...
* standalone-full.xml
** Jakarta Enterprise Edition {javaee_version} full profile certified configuration
including all the required EE {javaee_version} technologies

* standalone-full-ha.xml
** Jakarta Enterprise Edition {javaee_version} full profile certified configuration with
high availability
...
* domain.xml
** Jakarta Enterprise Edition {javaee_version} full and web profiles available with or
