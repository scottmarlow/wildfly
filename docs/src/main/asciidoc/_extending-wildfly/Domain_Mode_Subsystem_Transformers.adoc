...
attributes. These have been added in WildFly {wildflyVersion} which supports Jakarta EE 8,
and thus CDI 1.1. JBoss AS 7.x supports Jakarta EE 8, and thus CDI 1.0. In
