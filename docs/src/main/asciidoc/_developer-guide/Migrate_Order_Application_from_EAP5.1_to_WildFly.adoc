...
support Jakarta Enterprise Beans reference injection, the servlets were using pre-EE 5
...
from the modification to use Jakarta Enterprise Beans reference injection in the servlets.
