...
lib directory, or classes defined in other Jakarta Enterprise Beans jars.
...
the `EAR/lib` directory is a single module, and every WAR or Jakarta Enterprise Beans jar
...
<jboss-deployment-structure>
  ...
  <sub-deployment name="myapp.war">
    ...
    <dependencies>
      <!-- Adds a dependency on a Jakarta Enterprise Beans jar. This could also be done with a Class-Path entry -->
